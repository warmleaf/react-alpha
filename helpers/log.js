(function() {
    ...
    formats = [{
        ...
        styles: function() {
            return ['color: green;font-weight: bold;font-style: italic', ''];
        }
    }, {
        regex: /\<_G([^\<_G]+)\>/,
        replacer: function(m, p1) {
        ...
        styles: function() {
            return ['color: yellow;font-style: italic', ''];
        }
    }, {
        regex: /\<\-Y([^\<\-Y]+)\>/,
        replacer: function(m, p1) {
        ...
        styles: function() {
            return ['color: yellow;font-weight: bold;font-style: italic', ''];
        }
    }, {
        regex: /\<\_Y([^\<\_Y]+)\>/,
        replacer: function(m, p1) {
        ...
        styles: function() {
            return ['color: cyan;font-style: italic', ''];
        }
    }, {
        regex: /\<\-C([^\<\-C]+)\>/,
        replacer: function(m, p1) {
        ...
        styles: function() {
            return ['color: cyan;font-weight: bold;font-style: italic', ''];
        }
    }, {
        regex: /\<\_C([^\<\_C]+)\>/,
        replacer: function(m, p1) {
