...
export default function getPropDefinitions(component) {
  if (!component.type) { // eslint-disable-line
    return null
  }
  const propDefinitionsMap = hasDocgen(component.type)
    ? propsFromDocgen(component.type)
    : propsFromPropTypes(component.type)
