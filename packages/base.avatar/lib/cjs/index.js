/* @react-alpha/base.avatar version 0.3.0
 *
...
var React = require("react"), React__default = _interopDefault(React), propTypes = require("prop-types"), styledComponents = require("styled-components"), Flex = _interopDefault(require("@react-alpha/base.flex")), _extends = Object.assign || function(e) {
...
styledComponents.injectGlobal(_templateObject);
...
var Avatar = function(e) {
    ...
    return React__default.createElement(Flex, _extends({
        ...
        w: a,
        h: a
    }, o), React__default.createElement(Flex, {
        full: !0,
        noRepeatBg: !0,
        round: "50%",
        bgi: t
